...
import com.niit.diaspora.back.utility.FileUpload;
import com.niit.diaspora.back.viewmodel.ProfileModel;
...
public class UserController {
	...
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(value = "userId") String userJson,
		...
		String path = "E:\\Mukil\\workspace\\diaspora\\diaspora\\WebContent\\assets\\images\\users";
